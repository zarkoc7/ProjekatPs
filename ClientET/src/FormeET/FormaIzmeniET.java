 ...
 * @author Zarko
 */
public class FormaIzmeniET extends javax.swing.JDialog {

    Trotinet ovaj;
    /**
     * Creates new form FormaIzmeniET
     */
    public FormaIzmeniET(JDialog parent, boolean modal, Trotinet t) {
        super(parent, modal);
        initComponents();
        ovaj=t;
        ...
        txtSifra.setText(t.getSifraT());
        txtPay.setText(Integer.toString(t.getMaxPayload()));
        txtPo.setText(Integer.toString(t.getMaxPower()));
        txtRa.setText(Integer.toString(t.getMaxRange()));
        txtSp.setText(Integer.toString(t.getMaxSpeed()));
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            if (txtPay.getText().isEmpty()|| txtRa.getText().isEmpty()|| txtSp.getText().isEmpty()|| txtPo.getText().isEmpty()) {
            ...
            ovaj.setMaxSpeed(brzina);
            ovaj.setMaxPayload(nosivost);
            ovaj.setMaxPower(snaga);
            ovaj.setMaxRange(range);           
            ClientKontroler.getInstance().updateET(ovaj);
            System.out.println("radi ovde");
            JOptionPane.showMessageDialog(this, "E-trotinet je uspesno izmenjen");
            FormaPretragaET fp=(FormaPretragaET) getParent();
            fp.reakcija();
            this.dispose();
        } catch (Exception ex) {
